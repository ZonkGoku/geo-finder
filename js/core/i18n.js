...
const DICT = {
  en: {
    ...
    // Volle "So funktioniert's"-Regeln pro Modus (siehe #mode-rules-modal in
    // index.html, showModeRulesModal() in app.js) - bewusst zusaetzlich zum
    // knappen Einzeiler oben (modePointsNote usw.): der Einzeiler reicht zum
    // schnellen Ueberfliegen beim Modus-Wechsel, aber "kann jeder Idiot
    // verstehen" (O-Ton Nutzer) brauchte einen expliziten Schritt-fuer-
    // Schritt-Ablauf, den man sich bei Bedarf per Klick aufklappt statt ihn
    // immer im Lobby-Layout stehen zu haben.
    modeRulesTitle: 'How to play',
    modeRulesCta: 'How does this work?',
    rulesPoints1: "You'll see a real 360° photo from somewhere in the world.",
    rulesPoints2: 'Drop a pin on the map where you think it was taken.',
    rulesPoints3: 'The closer your pin, the more points you get - plus a bonus for guessing fast.',
    rulesPoints4: 'Most points after all rounds wins.',
    rulesHp1: 'Both players start with 6000 HP (health).',
    rulesHp2: 'Same as Points Duel: guess the spot on the map each round.',
    rulesHp3: 'Whoever guessed worse loses HP - exactly as many points as the gap between you two.',
    rulesHp4: 'First one to hit 0 HP loses.',
    rulesCountryStreak1: "You'll see a 360° photo - but only the COUNTRY matters this time.",
    rulesCountryStreak2: 'Click anywhere inside the correct border. The exact spot makes no difference.',
    rulesCountryStreak3: 'Right country = 1 point. Wrong country = 0 points.',
    rulesCountryStreak4: 'Most correct countries after all rounds wins.',
    rulesHeatmap1: 'No photos this round - just type a country name into the search box.',
    rulesHeatmap2: 'After each guess the world map lights up: warmer color = closer to the real country.',
    rulesHeatmap3: 'Keep guessing until you find the right country.',
    rulesHeatmap4: 'Fewer guesses needed = you win the round.',
    rulesBattleRoyale1: 'Just like Points Duel, but built for 3+ players in one lobby.',
    rulesBattleRoyale2: 'After every round, whoever guessed worst is eliminated.',
    rulesBattleRoyale3: 'Round count is automatic: always one less than the number of players.',
    rulesBattleRoyale4: 'Last player still standing wins. Needs at least 2 players to start.',
  ...
  de: {
    ...
    rulesPoints1: 'Du siehst ein echtes 360°-Foto von irgendwo auf der Welt.',
    rulesPoints2: 'Du setzt einen Pin auf der Karte, wo du glaubst, dass es aufgenommen wurde.',
    rulesPoints3: 'Je näher dein Pin am echten Ort ist, desto mehr Punkte bekommst du - plus Bonus für schnelles Raten.',
    rulesPoints4: 'Wer nach allen Runden die meisten Punkte hat, gewinnt.',
    rulesHp1: 'Beide Spieler starten mit 6000 Lebenspunkten (HP).',
    rulesHp2: 'Wie beim Punkte-Duell: jede Runde tippst du den Ort auf der Karte.',
    rulesHp3: 'Wer schlechter geraten hat, verliert HP - genau so viele Punkte, wie der Abstand zwischen euch beiden beträgt.',
    rulesHp4: 'Wessen HP zuerst auf 0 fällt, verliert.',
    rulesCountryStreak1: 'Du siehst ein 360°-Foto - diesmal zählt nur das LAND.',
    rulesCountryStreak2: 'Ein Klick irgendwo innerhalb der richtigen Grenze reicht. Die genaue Stelle ist egal.',
    rulesCountryStreak3: 'Richtiges Land = 1 Punkt. Falsches Land = 0 Punkte.',
    rulesCountryStreak4: 'Wer nach allen Runden die meisten richtigen Länder hat, gewinnt.',
    rulesHeatmap1: 'Diesmal keine Fotos - du tippst stattdessen einen Landesnamen ins Suchfeld.',
    rulesHeatmap2: 'Nach jedem Tipp leuchtet die Weltkarte auf: wärmere Farbe = näher am gesuchten Land.',
    rulesHeatmap3: 'Rate weiter, bis du das richtige Land gefunden hast.',
    rulesHeatmap4: 'Wer das Land mit den wenigsten Tipps findet, gewinnt die Runde.',
    rulesBattleRoyale1: 'Wie beim Punkte-Duell, aber gedacht für 3 oder mehr Spieler in einer Lobby.',
    rulesBattleRoyale2: 'Nach jeder Runde fliegt automatisch, wer am schlechtesten geraten hat.',
    rulesBattleRoyale3: 'Die Rundenzahl ist automatisch: immer eine Runde weniger als Spieler dabei sind.',
    rulesBattleRoyale4: 'Wer als Letzte:r übrig bleibt, gewinnt. Braucht mindestens 2 Spieler zum Start.',
